...
export default function Countdown() {
  ...
  return (
    <div className="w-full bg-neutral-950 text-white py-4 sm:py-3 border-b border-gold-900/20 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8">
        <div className="flex items-center text-center md:text-left">
          <h1 className="text-2xl sm:text-2xl md:text-3xl font-black italic tracking-tighter text-white leading-none">
            Gin sin Nombre
          </h1>
        </div>
        
        <div className="flex items-center justify-center gap-3 sm:gap-4 md:gap-8 bg-white/5 md:bg-transparent p-3 sm:p-0 rounded-2xl md:rounded-0 w-full md:w-auto">
